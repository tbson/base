        ...
        attachments = [
            {
                ...
                "fields": [
                    ...
                    {
                        "title": "Method",
                        "value": request.method if request else no_request,
                        "short": True,
                    },
                    {
                        "title": "Path",
                        "value": request.path if request else no_request,
                        "short": True,
                    },
                    {
                        "title": "User",
                    ...
                    {
                        "title": "GET Params",
                        "value": json.dumps(request.GET) if request else no_request,
                        "short": False,
                    },
                    {
                        "title": "POST Data",
                        "value": json.dumps(request.POST) if request else no_request,
                        "short": False,
                    },
                ],
            },
