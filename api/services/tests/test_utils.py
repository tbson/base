...
class RemoveSpecialChars(SimpleTestCase):
    def test_normal_case(self):
        input_data = "abc"
        output = Utils.remove_special_chars(input_data)
        eput = "abc"
        self.assertEqual(output, eput)
    ...
    def test_special_case_upper(self):
        input_data = " abc* "
        output = Utils.remove_special_chars(input_data, True)
        eput = "ABC"
        self.assertEqual(output, eput)
...
class PasswordValidate(SimpleTestCase):
    def test_happy_case(self):
        input_data = "1Abcdefg"
        output = Utils.password_validate(input_data)
        eput = []
        self.assertEqual(output, eput)
...
class DateStrStripMillisecs(SimpleTestCase):
    def test_happy_case(self):
        ...
        output = Utils.date_str_strip_millisecs(input_data)
...
class MaskPhoneNumber(SimpleTestCase):
    def test_happy_case(self):
        ...
        output = Utils.mask_prefix(input_data)
        eput = "********6527"
        self.assertEqual(output, eput)
    ...
    def test_happy_case_1(self):
        input_data = "+84906696527"
        mask_length = 5
        output = Utils.mask_prefix(input_data, mask_length)
        eput = "*******96527"
        self.assertEqual(output, eput)
...
class MaskEmail(SimpleTestCase):
    def test_name_1(self):
        ...
        output = Utils.mask_email(input_data)
        eput = "*@gmail.com"
        self.assertEqual(output, eput)
...
class IsBooleanDict(SimpleTestCase):
    def test_all_boolean(self):
        ...
        output = Utils.is_boolean_dict(input_data)
        eput = True
        self.assertEqual(output, eput)
...
class EnsureSpaceSlash(SimpleTestCase):
    def test_happy_case(self):
        input_data = "abc/def"
        output = Utils.ensure_space_slash(input_data)
        eput = "abc / def"
        self.assertEqual(output, eput)
